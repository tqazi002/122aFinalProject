// help from: http://people.ece.cornell.edu/land/courses/ece4760/FinalProjects/f2014/mrr222_va86_dar324/4760%20Final%20Page/TouchScreen.c
// help from: http://people.ece.cornell.edu/land/courses/ece4760/FinalProjects/s2012/bth44_pb334/bth44_pb334/TouchScreen.c
// both help files are modified and/or used for information
...
void RoundRect (int x0, int y0, int x1, int y1, int r, int color)
...
int main()
{
 ...
 while(1){
	 ...
	 if((press < 10) || (press > 1000)){
		 ...
		 char *str2 = "mx";
		 GotoXY(1,7);
		 WriteString(str2,MAGENTA);
		 GotoXY(1,8);
		 WriteInt(xm);
		 
		 char *str3 = "my";
		 GotoXY(1,10);
		 WriteString(str3,MAGENTA);
		 GotoXY(1,11);
		 WriteInt(ym);
		 */
	 }
